<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-800">Add Parameter</h2>
    </x-slot>

    <div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow">
        <a href="{{ route('parameters.index') }}" class="text-blue-600 hover:underline mb-4 inline-block">← Back to Parameters</a>
